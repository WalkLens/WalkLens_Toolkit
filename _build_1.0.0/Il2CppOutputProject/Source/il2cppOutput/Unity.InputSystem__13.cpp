...
IL_0039_1:
			...
			}
			{
				...
				NullCheck(L_16);
				bool L_18;
				L_18 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(30 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_16, L_17);
				G_B7_0 = ((int32_t)(L_18));
				goto IL_0059_1;
			}
...
IL_0063_1:
			{
				...
				NullCheck(L_21);
				bool L_23;
				L_23 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(30 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_21, L_22);
